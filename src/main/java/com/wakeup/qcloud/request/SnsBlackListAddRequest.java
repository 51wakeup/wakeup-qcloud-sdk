...
/**
 * 添加黑名单
 * https://www.qcloud.com/document/product/269/3718
 * 
 * @since 2017年3月4日
 * @author kalman03
 */
public class SnsBlackListAddRequest extends AbstractQCloudIMRequest<SnsFriendResponse> {

	private static final long serialVersionUID = -7973614575899011644L;
	/**
	 *必填	需要为该Identifier添加黑名单。
	 */
